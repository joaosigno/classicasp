...
<head>
    ...
    <title>RSS Flickr</title>

<!-- #include file="./../_lib/asp3tojson.lib.asp" -->
<!-- #include file="./../_view/_admin/_elenco.view.asp" -->
...
<script language="javascript" type="text/javascript">
	...
	function startNewRss() {
		...
		$_('aRssTipoMidia_').value = 'FlickrElenco';
		$_('aRssUrl_').value = '';
	}
...
<h1>RSS Feeds do Flickr (Para o elenco)</h1>
...
<div id="containerRSS">
	<div id="theGridraw" style="display:none;">
		...
		<span mjt.for="n in objRss.rss">
			${n.principalelenco==1?'>>PRINCIPAL<<':setPrincipalRSS(n.idrss)}
			<br />
