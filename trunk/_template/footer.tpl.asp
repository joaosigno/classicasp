...
<!-- START FOOTER -->
	...
	<div id="footer">
		<div id="boxfooter">
			<div id="seres">
				<a class="quickLink" href="javascript:void(0);" onclick="document.location.replace('./grupo.asp',true);">o grupo</a> | 
				...
				<a class="quickLink" href="javascript:void(0);" onclick="window.open('http:///diarioseres.blogspot.com','_blank');">diário de bordo</a> | 
